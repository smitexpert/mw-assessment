            ...
            <div class="col-md-6">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body border">
                        <vue-dropzone ref="myVueDropzone" id="dropzone" :options="dropzoneOptions" v-on:vdropzone-success="imageSuccessUpload"></vue-dropzone>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        imageSuccessUpload(file, response) {
